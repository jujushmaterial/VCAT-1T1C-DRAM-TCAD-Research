# Phase 1 산출물 — P01-T09-O01_svisual_metric_extraction

- 과제 ID: `P01-T09`
- 산출물 ID: `P01-T09-O02`
- 제출자: 송민호 (`@minhosong-mse`)
- 제출 시각: 2026-08-06T10:15:10.351Z
- 관련 Issue: [#1](https://github.com/jujushmaterial/VCAT-1T1C-DRAM-TCAD-Research/issues/1)
- 제출 방식: code

## 1. P01-T09-O01_svisual_metric_extraction

- 코드 종류: Sentaurus SDevice
- 원본 파일: [`P01-T09-O01_svisual_metric_extraction.cmd`](./source/P01-T09-O01_svisual_metric_extraction.cmd)
