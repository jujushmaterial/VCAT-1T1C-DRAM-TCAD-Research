# Phase 8 산출물 — P8 공통 Sweep·추출 코드

- 과제 ID: `P08-T01`
- 산출물 ID: `P08-T01-O03`
- 제출자: 송민호 (`@minhosong-mse`)
- 제출 시각: 2026-08-22T14:45:40.150Z
- 관련 Issue: [#8](https://github.com/jujushmaterial/VCAT-1T1C-DRAM-TCAD-Research/issues/8)
- 제출 방식: code

## 1. P08-T01-O03_P8_Parameterized_SDE

- 코드 종류: Sentaurus SDE
- 원본 파일: [`P08-T01-O03_P8_Parameterized_SDE.cmd`](./source/P08-T01-O03_P8_Parameterized_SDE.cmd)
...
## 2. P08-T01-O03_P8_Forward_SDevice

- 코드 종류: Sentaurus SDevice
- 원본 파일: [`P08-T01-O03_P8_Forward_SDevice.cmd`](./source/P08-T01-O03_P8_Forward_SDevice.cmd)
...
## 3. P08-T01-O03_P8_GIDL_PRODFAST_SDevice

- 코드 종류: Sentaurus SDevice
- 원본 파일: [`P08-T01-O03_P8_GIDL_PRODFAST_SDevice.cmd`](./source/P08-T01-O03_P8_GIDL_PRODFAST_SDevice.cmd)
...
P08-T01-O03 — P8 공통 Sweep·추출 코드

목적
- P8 primary 31-point campaign을 동일한 geometry 생성, SDevice physics/bias, metric extraction으로 재현할 수 있게 한다.

포함 코드
- Parameterized SDE
- Forward SDevice
- GIDL PRODFAST SDevice
- P8 metric extraction utility
- Code provenance / extraction validation 표

실행 검증
- Forward 0.05 V 31/31 + Forward 1.0 V 31/31 + GIDL 31/31 = 93/93 SDevice 유효
- P5 overlap 9점의 Forward 주요 metric이 기존 값과 재현됨
- P5 known GIDL point도 재현됨

주의
- 대용량 TDR/PLT/LOG는 GitHub 패키지에 포함하지 않고 서버 원본으로 유지한다.
