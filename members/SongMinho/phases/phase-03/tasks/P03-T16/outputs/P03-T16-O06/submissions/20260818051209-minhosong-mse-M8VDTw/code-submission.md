# Phase 3 산출물 — P4 전달 SDE·SDevice 코드

- 과제 ID: `P03-T16`
- 산출물 ID: `P03-T16-O06`
- 제출자: 송민호 (`@minhosong-mse`)
- 제출 시각: 2026-08-18T05:12:09.538Z
- 관련 Issue: [#3](https://github.com/jujushmaterial/VCAT-1T1C-DRAM-TCAD-Research/issues/3)
- 제출 방식: code

## 1. P03-T16-O06_P4_Handoff_SDE_MeshON

- 코드 종류: Sentaurus SDE
- 원본 파일: [`P03-T16-O06_P4_Handoff_SDE_MeshON.cmd`](./source/P03-T16-O06_P4_Handoff_SDE_MeshON.cmd)
...
## 2. P03-T16-O06_P4_Handoff_Forward_SDevice

- 코드 종류: Sentaurus SDevice
- 원본 파일: [`P03-T16-O06_P4_Handoff_Forward_SDevice.cmd`](./source/P03-T16-O06_P4_Handoff_Forward_SDevice.cmd)
...
## 3. P03-T16-O06_P4_Handoff_GIDL_SDevice

- 코드 종류: Sentaurus SDevice
- 원본 파일: [`P03-T16-O06_P4_Handoff_GIDL_SDevice.cmd`](./source/P03-T16-O06_P4_Handoff_GIDL_SDevice.cmd)
...
Phase 4에 전달할 최종 SDE/SDevice 코드입니다. P4 handoff SDE는 WF-boundary refinement를 유지한 Mesh ON 코드이며 Forward 및 GIDL SDevice와 고정 SWB 파라미터를 함께 제공합니다. Mesh OFF SDE는 O04 sensitivity 비교용으로만 사용합니다.

P03-T16 / P4 handoff fixed parameters

Representative geometry
- Structure: Low-High-Low three-zone VCAT
- M1Ratio = 1
- M2Ratio = 2
- M3Ratio = 1
- Segment lengths = 15 / 30 / 15 nm
- Lg = 60 nm
- Xgate = 0.020 ~ 0.080 um
- Xbnd1 = 0.035 um
- Xbnd2 = 0.065 um

Fixed work functions
- WF_LOW = 4.33 eV (Ti)
- WF_HIGH = 4.70 eV (TiN)
...
Forward: VgStop=1.0 V, VdBias=0.05 / 1.0 V
GIDL: GIDLDrain=1.0 V, GIDLGateStop=-0.4 V

Final mesh handoff
- Use Mesh ON SDE (WF-boundary dedicated refinement retained).
- Mesh OFF is the T16 sensitivity-comparison case only.
