...
- 제출 시각: 2026-08-17T14:33:54.180Z
- 관련 Issue: [#3](https://github.com/jujushmaterial/VCAT-1T1C-DRAM-TCAD-Research/issues/3)
- 제출 방식: files

## 제출 파일

- [P03-T15-O05_Bidirectional_Current_Asymmetry.xlsx](./files/P03-T15-O05_Bidirectional_Current_Asymmetry.xlsx) (8.9KB)
- [P03-T15-O05_Bidirectional_Current_Asymmetry_Summary.csv](./files/P03-T15-O05_Bidirectional_Current_Asymmetry_Summary.csv) (871B)
- [P03-T15-O05_Summary_Preview.png](./files/P03-T15-O05_Summary_Preview.png) (147.7KB)
- [README.md](./files/README.md) (1.3KB)
